...
public class FragmentItaly extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        imageViewItaly =view.findViewById(R.id.imageViewpyramid);
        progressBarItaly = view.findViewById(R.id.progressBarpyramid);

        Picasso.get().load("https://cdn.britannica.com/59/1759-050-FCD5A574/Flag-Italy.jpg")
